 ...
 * @author acer
 */
public class Jika_Lupa extends javax.swing.JFrame {
    Connection cnn;
    ResultSet rss;
    Statement stt;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if ("".equals(txtid_petugas.getText()) || "".equals(txtnama_petugas.getText()) 
            ...
            String SQL = "UPDATE petugas set admin = '"+ txtadmin.getText()
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Jika_Lupa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
