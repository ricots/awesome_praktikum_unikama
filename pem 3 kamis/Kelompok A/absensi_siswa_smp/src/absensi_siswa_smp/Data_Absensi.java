...
public class Data_Absensi extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("KD ABSEN");

        jLabel4.setText("KETERANGAN");

        jLabel5.setText("KD JADWAL");
        ...
        jTable3.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "KD ABSEN", "KETERANGAN", "KD JADWAL", "NIS"
            }
        ));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jTextField1.getText().equals("")) {
            JOptionPane.showMessageDialog(rootPane, "Kd_absen");
        }
        else if (jTextField2.getText().equals("")) {
            JOptionPane.showMessageDialog(rootPane, "keterangan");
        }
        else if (jTextField3.getText().equals("")) {
            JOptionPane.showMessageDialog(rootPane, "kd_jadwal");
        }
        else if (jTextField4.getText().equals("")) {
            JOptionPane.showMessageDialog(rootPane, "nis");
        }
        else{
        db.dbConnection();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (jTextField1.getText().equals("")) {
            JOptionPane.showMessageDialog(rootPane, "Masukan Kode Absen");
        }
        else if (jTextField2.getText().equals("")) {
            JOptionPane.showMessageDialog(rootPane, "Masukan Katerangan");
        }
        else if (jTextField3.getText().equals("")) {
            JOptionPane.showMessageDialog(rootPane, "Masukan Kode Jadwal");
        }
        else if (jTextField4.getText().equals("")) {
            JOptionPane.showMessageDialog(rootPane, "Masukan NIS");
        }
        else{
        ...
        tbl.addColumn("kd_absen");
        tbl.addColumn("Artikel");
        jTable1.setModel(tbl);
        try{
           stt = (Statement) db.getConnection().createStatement();
            String sql = "UPDATE tb_absen set kd_absen = '"+jTextField2.getText()
                    + "',keterangan ='"+jTextField3.getText()
                    +"',kd_jadwal ='"+jTextField4.getText()+"' where nis='"+jTextField1.getText()+"';";
