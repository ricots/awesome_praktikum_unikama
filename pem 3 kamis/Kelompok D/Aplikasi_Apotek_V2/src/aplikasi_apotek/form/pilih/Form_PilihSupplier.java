 ...
 * @author Win 8.1
 */
public class Form_PilihSupplier extends javax.swing.JFrame {

    public Connection conn;
    public Statement stat;
    public Form_Obat fps = null;
   
    
    public Form_PilihSupplier() {
        initComponents();
        tampildata();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_PilihSupplier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new Form_PilihSupplier().setVisible(true);
            }
        });
    }
