...
<body>
    <div>
        <?php
            ...
            $query       = mysql_query("select * from fakultas where id_fak='$id_fakultas'");
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <form method="post" action="fakultas-update.php">
                            <div class="form-group">
                                <label>Nama Fakultas</label>
                                <input type="hidden" class="form-control" name="id_fak" value="<?php echo $data['id_fak']; ?>">
                                <input type="text" class="form-control" name="nama_fak" value="<?php echo $data['nama_fak']; ?>">
                            </div>
                            <div class="form-group">
