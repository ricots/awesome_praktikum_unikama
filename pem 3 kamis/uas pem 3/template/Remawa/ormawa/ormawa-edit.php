...
<body>
    <div>
        <?php
            ...
            $Id_orm      = $_GET['Id_orm'];
            $query       = mysql_query("select * from ormawa where Id_orm='$Id_orm'");
                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="menu-top-active" href="fakultas.php">Ormawa</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <form method="post" action="ormawa-update.php">
                            <div class="form-group">
                                <label>Nama Fakultas</label>
                                <input type="hidden" class="form-control" name="Id_orm" value="<?php echo $data['Id_orm']; ?>">
                                <input type="text" class="form-control" name="nama_ormawa" value="<?php echo $data['nama_ormawa']; ?>">
                            </div>
                            <div class="form-group">
