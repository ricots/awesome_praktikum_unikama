                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <li><a class="menu-top-active" href="ormawa.php">Ormawa</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="table-responsive">
                        ...
                        <div class="col-md-4">
                            <button type="button" class="btn btn-primary" onclick="location.href='ormawa-add.php'">Tambah Ormawa</button>
                        </div>
                        ...
                        <tbody>
                            <?php 
                                ...
                                $query = mysql_query("SELECT * FROM ormawa LIMIT $posisi, $batas");
                             ...
                             <tr class="<?php if($i % 2 == 0) { echo "odd";} else { echo "even";} ?>">
                                 ...
                                 <td>
                                     <?php 
                                      ...
                                      ?>
                                      <div>
                                          <a href="ormawa-edit.php?Id_orm=<?php echo $data['Id_orm']; ?>" class="label label-info">Edit</a>
                                          |
                                          <a href="ormawa-delete.php?Id_orm=<?php echo $data['Id_orm']; ?>" class="label label-danger">Delete</a>
                        ...
                        <nav aria-label="...">
                            <?php
                                $jml_data   = mysql_num_rows(mysql_query("SELECT * FROM ormawa"));
