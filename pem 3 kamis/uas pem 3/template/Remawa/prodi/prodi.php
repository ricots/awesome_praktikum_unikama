                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <li><a class="menu-top-active" href="prodi.php">Prodi</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="table-responsive">
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                            <button type="button" class="btn btn-primary" onclick="location.href='prodi-add.php'">Tambah Prodi</button>
                        </div>
                        ...
                        <tbody>
                            <?php 
                                ...
                                $query = mysql_query("SELECT * FROM prodi LIMIT $posisi, $batas");
                             ...
                             <tr class="<?php if($i % 2 == 0) { echo "odd";} else { echo "even";} ?>">
                                 ...
                                 <td>
                                     <?php 
                                      ...
                                      ?>
                                      <div>
                                          <a href="prodi-edit.php?id_prd=<?php echo $data['id_prd']; ?>" class="label label-info">Edit</a>
                                          |
                                          <a href="prodi-delete.php?id_prd=<?php echo $data['id_prd']; ?>" class="label label-danger">Delete</a>
                        ...
                        <nav aria-label="...">
                            <?php
                                $jml_data   = mysql_num_rows(mysql_query("SELECT * FROM prodi"));
