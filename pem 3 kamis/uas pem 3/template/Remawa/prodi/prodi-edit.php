...
<body>
    <div>
        <?php
            ...
            $query       = mysql_query("select * from prodi where id_prd='$id_prodi'");
                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="menu-top-active" href="prodi.php">Prodi</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <form method="post" action="prodi-update.php">
                            <div class="form-group">
                                <label>Nama Prodi</label>
                                <input type="hidden" class="form-control" name="id_prd" value="<?php echo $data['id_prd']; ?>">
