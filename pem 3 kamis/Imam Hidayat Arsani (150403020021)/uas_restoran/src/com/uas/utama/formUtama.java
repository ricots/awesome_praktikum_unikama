...
public class formUtama extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn_simpan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/uas/Icon/sv.jpg"))); // NOI18N
        ...
        makanan.add(btn_simpan, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 290, 100, 40));

        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/uas/Icon/dt.jpg"))); // NOI18N
        ...
        makanan.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 290, -1, 40));

        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/uas/Icon/Delete.png"))); // NOI18N
        ...
        makanan.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 290, 100, 40));

        jLabel4.setText("Harga           :");
        makanan.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 260, -1, -1));
        ...
        makanan.add(txtidmakanan, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 90, 220, 30));

        jLabel2.setText("ID Paket        :");
        makanan.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 100, -1, -1));
        ...
        makanan.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 340, 509, 179));
        ...
        makanan.add(txtharga, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 250, 220, 30));
        makanan.add(txtnamapaket, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 130, 220, 30));

        jLabel5.setText("Keterangan   :");
        makanan.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 200, -1, -1));

        txtketerangan.setColumns(20);
        txtketerangan.setRows(5);
        jScrollPane3.setViewportView(txtketerangan);

        makanan.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 170, 220, 70));
        ...
        transaksi.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 130, -1, -1));

        jLabel14.setText("Kode Paket     :");
        transaksi.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 160, -1, -1));

        jLabel15.setText("Nama Paket    :");
        transaksi.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 190, -1, -1));

        jLabel16.setText("Harga             :");
        transaksi.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 220, -1, -1));

        jLabel17.setText("Jumlah           :");
        transaksi.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 250, -1, -1));
        ...
        transaksi.add(tgl_transaksi, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 100, 250, -1));

        txt_no_transaksi.setEditable(false);
        transaksi.add(txt_no_transaksi, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 130, 50, -1));

        txt_nama_paket.setEnabled(false);
        transaksi.add(txt_nama_paket, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 190, 250, -1));
        ...
        transaksi.add(cmb_kode, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 160, 250, -1));
        ...
        transaksi.add(txt_jumlah_t, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 250, 70, -1));

        txt_harga_t.setEnabled(false);
        transaksi.add(txt_harga_t, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 220, 70, -1));

        jButton7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/uas/Icon/Buy.png"))); // NOI18N
        ...
        transaksi.add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 280, 80, 30));
        ...
        transaksi.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 340, 495, 95));
        ...
        transaksi.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 130, 150, -1));

        txt_id_kasir.setEditable(false);
        transaksi.add(txt_id_kasir, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 10, 50, -1));

        txt_total_semua.setEditable(false);
        transaksi.add(txt_total_semua, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 440, 142, 30));

        jLabel18.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        jLabel18.setText("Total   :");
        transaksi.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 450, -1, -1));

        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/uas/Icon/Delete.png"))); // NOI18N
        ...
        transaksi.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 290, 90, 30));

        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/uas/Icon/printer.png"))); // NOI18N
        ...
        transaksi.add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 440, -1, -1));

        jLabel7.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        jLabel7.setText("Id Admin :");
        transaksi.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 10, -1, -1));
        ...
        jMenuItem2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/uas/Icon/File.png"))); // NOI18N
        ...
        jMenuItem3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/uas/Icon/logout.png"))); // NOI18N
        ...
        jMenuItem4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/uas/Icon/gtk-edit.png"))); // NOI18N
        ...
        jMenuItem1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/uas/Icon/proses_1.png"))); // NOI18N
        ...
        try {
         if(btn_simpan.getText().equals("Batal")){
            ...
            if(txtidmakanan.getText().equals("")||txtnamapaket.getText().equals("")||txtketerangan.getText().equals("")||txtharga.getText().equals("")){
                JOptionPane.showMessageDialog(this, "Isi data yang kosong", "Pesan", JOptionPane.WARNING_MESSAGE);
            }
            else{    
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try {
            stt = con.createStatement();
            if(row == -1){
                JOptionPane.showMessageDialog(this, "Pilih tabel dengan benar");
            }
            else{
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        Connection con = koneksi.getConnection();
            String NamaFile = "/com/uas/laporan/Struk_Pembayaran.jasper";
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        Connection con = koneksi.getConnection();
            String NamaFile = "/com/uas/laporan/laporan_penjualan.jasper";
            HashMap hash = new HashMap();
        try {
