...
if(empty($halaman)){
   ...
   $sql = "SELECT * FROM poliklinik WHERE $skripsi LIKE '%$search%' ORDER BY kd_poli ASC LIMIT $posisi,$batas ";
   $no=$posisi + 1;
...
<table border="1">
<tr>
<th>No</th><th>Kd Poli</th><th>Nama Poliklinik</th><th>Lantai</th></tr>
	<?php
...
echo "<br>Halaman :&nbsp;";
	  ...
	  { $skripsi = $_GET['kombo'];}
$tampil2="SELECT * FROM poliklinik WHERE $skripsi LIKE '%$search%' ORDER BY kd_poli ASC";
