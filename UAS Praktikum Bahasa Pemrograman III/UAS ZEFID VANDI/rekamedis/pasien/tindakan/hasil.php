...
if(empty($halaman)){
   ...
   $sql = "SELECT * FROM tindakan WHERE $skripsi LIKE '%$search%' ORDER BY kd_tindakan ASC LIMIT $posisi,$batas ";
   $no=$posisi + 1;
...
<table border="1">
<tr>
<th>No</th><th>Kd Tindakan</th><th>Nama Tindakan</th><th>Ket</th></tr>
	<?php
...
echo "<br>Halaman :&nbsp;";
	  ...
	  { $skripsi = $_GET['kombo'];}
$tampil2="SELECT * FROM tindakan WHERE $skripsi LIKE '%$search%' ORDER BY kd_tindakan ASC";
