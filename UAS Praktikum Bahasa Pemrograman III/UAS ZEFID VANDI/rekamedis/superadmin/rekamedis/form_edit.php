...
if($row[kd_tindakan]==$data1[kd_tindakan]){
	echo "<option value=$data1[kd_tindakan] selected>$data1[nm_tindakan]";	
}
else{
	echo "<option value=$data1[kd_tindakan]>$data1[nm_tindakan]";	
}
}
?>
</select>
...
if($row[kd_obat]==$data2[kd_obat]){
	echo "<option value=$data2[kd_obat] selected>$data2[nm_obat]";	
}
else{
	echo "<option value=$data2[kd_obat]>$data2[nm_obat]";	
}
}
?>
</select>
...
if($row[kd_user]==$data3[kd_dokter]){
	echo "<option value=$data3[kd_dokter] selected>$data3[nm_dokter]";	
}
else{
	echo "<option value=$data3[kd_dokter]>$data3[nm_dokter]";	
}
}
?>
</select>
...
if($row[no_pasien]==$data4[no_pasien]){
	echo "<option value=$data4[no_pasien] selected>$data4[nm_pasien]";	
}
else{
	echo "<option value=$data4[no_pasien]>$data4[nm_pasien]";	
}
}
?>
