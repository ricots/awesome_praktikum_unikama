...
<input class="submit" type="submit" value="TAMBAH DOKTER" />
</form>
<br />
<table border="1">
<tr>
<th>No</th><th>Kd Dokter</th><th>Kd Poli</th><th>Tgl kunjungan</th><th>Nama</th><th>SIP</th><th>Tmp Lahir</th><th>No Telp</th><th>Alamat</th><th>Aksi</th></tr>
<?php
include "../../connect.php";
$batas = 5;
...
while ($row=mysql_fetch_array($hasil)){
	...
	echo "<td>
	<a href=form_edit.php?kd_dokter=$row[kd_dokter]>Edit</a>&nbsp; | 
	<a href=\"hapus_dokter.php?kd_dokter=$row[kd_dokter]\"onClick=\"return confirm('Apakah Anda benar-benar akan menghapus $row[nm_dokter]?')\">Hapus</a>
	</td></tr>";
	$no++;
}
echo"</table>";
